...
# 2026/08/21
    if sAPPTYPE =='explorer':
        sARGUMENT_A = Path(sARGUMENT_A)
        # If the last component looks like a file, return its parent
        if sARGUMENT_A.suffix:
            sARGUMENT_A=str(sARGUMENT_A.parent)
        else:
            sARGUMENT_A=str(sARGUMENT_A)



    # Examples
    #print(get_folder_path(r"\\10.236.177.4\Schneider\ScriptingPath\PLUGINS_COLOR\PDM_COLOR_VARIANTS.xlsm"))
    # \\10.236.177.4\Schneider\ScriptingPath\PLUGINS_COLOR

    #print(get_folder_path(r"\\10.236.177.4\Schneider\ScriptingPath\PLUGINS_COLOR"))
    # \\10.236.177.4\Schneider\ScriptingPath\PLUGINS_COLOR
